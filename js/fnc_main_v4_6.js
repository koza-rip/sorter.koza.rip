...
// 2022/7/9 Modified by sven @ svenxiety.xyz
// added async/await to startup and init to facilitate use of bestdori api
...
async function startup() {
  ...
  loader.style.display = 'none';
    ...
    for (i=0; i<ary_TitleData.length; i++) {
      ...
      console.log(ary_TitleData[i]);
      if (ary_TitleData[i] === "VIRTUAL SINGER") {
